    ...
    <footer class="footer">
      <div className="section footer-top">
        <div className="support">
          <h2 className="title support__title">KONTAKT I PODRŠKA</h2>
          <ul className="support__list">
            <li className="support__item">Adresa: Prote Nikole Kostića bb</li>
            <li className="support__item">Email: info@simel-bih.com</li>
            <li className="support__item">Skype: simel-bih</li>
          </ul>
        ...
        <div className="footer__main">
          <div className="about">
            <h2 className="about__title">O NAMA</h2>
          ...
          <div className="help">
            <h2 className="help__title">POMOĆ</h2>
        ...
        <div className="social">
          <h2 className="social__title">SOCIJALNE MREŽE</h2>
